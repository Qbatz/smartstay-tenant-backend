...
public interface AmentityRepository extends JpaRepository<AmenitiesV1, String> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AmenityInfoProjection> findCurrentlyAssignedAmenities(@Param("hostelId") String hostelId,
    ...
    @Query(value = """
            ...
            WHERE ca.customer_id = :customerId
              ...
              AND ca.end_date IS NULL
            """, nativeQuery = true)
    Long isAmenityAlreadyAssigned(@Param("customerId") String customerId,
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AmenityInfoProjection> findUnassignedAmenities(@Param("hostelId") String hostelId,
                                                        @Param("customerId") String customerId);
